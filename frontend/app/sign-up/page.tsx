        ...
        <div className="grid w-full gap-5 lg:grid-cols-[1fr_1fr]">
          <section className="auth-card order-2 rounded-4xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-950/40 backdrop-blur-xl sm:p-8 lg:order-1 lg:min-h-180">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-slate-300">
              Create an IntelliSeek account to keep your uploads, indexed
              chunks, chat history, and citations tied to your own source
              library.
            </p>
            <div className="mt-10 grid gap-3">
              {[
                "Upload PDF, DOCX, PPTX, TXT, and MD notes into your account.",
                "Retrieve only your own chunks with cosine Top-K search.",
                "Ask academic questions and get source-grounded answers.",
              ].map((item) => (
                <div
                  key={item}
          ...
          <section className="auth-card order-1 rounded-4xl border border-white/10 bg-slate-900/70 p-6 shadow-2xl shadow-slate-950/50 backdrop-blur-2xl sm:p-8 lg:order-2">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Use a provider or sign up with email.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex w-full items-center justify-center rounded-[22px] bg-violet-300 px-4 py-3 text-sm font-semibold text-slate-950 transition hover:bg-violet-200 hover:cursor-pointer disabled:cursor-not-allowed disabled:opacity-60"
              >
            ...
            <p className="mt-6 text-center text-sm text-slate-400">
              ...
              <Link href="/sign-in" className="text-cyan-200 underline hover:cursor-pointer">
                Sign in
              </Link>
            </p>
          </section>

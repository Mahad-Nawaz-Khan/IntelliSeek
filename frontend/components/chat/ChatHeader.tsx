...
export function ChatHeader({ onOpenUpload }: ChatHeaderProps) {
  ...
  return (
    <header className="hidden flex-col gap-4 px-4 pt-4 md:flex md:px-6 lg:flex-row lg:items-center lg:justify-between">
      <div>
      ...
      <div className="flex items-center gap-2">
        <PrimaryButton type="button" onClick={onOpenUpload} className="px-3 md:px-4">

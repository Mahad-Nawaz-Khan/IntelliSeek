...
export function ChatWelcome({ disabled = false, onSelect }: ChatWelcomeProps) {
  return (
    <section className="mx-auto my-0 flex w-full min-w-0 flex-col items-center px-0 py-0 text-center lg:max-w-4xl lg:px-4">
      ...
      <p className="mt-4 w-full max-w-full text-sm leading-7 text-slate-400 md:text-base lg:max-w-2xl">
        Upload notes or ask from the built-in knowledge base. IntelliSeek highlights source-grounded answers for academic review.
      </p>

      <div className="relative z-0 mt-10 grid w-full min-w-0 grid-cols-1 gap-3 lg:grid-cols-2">
